...
Exemplos de comportamento que contribui para um ambiente positivo:

- ✅ **Empatia e gentileza** para com outras pessoas
- ✅ **Respeito** por opiniões, pontos de vista e experiências diferentes
- ✅ **Feedback construtivo** dado e aceito graciosamente
- ✅ **Assumir responsabilidade** e pedir desculpas a quem é afetado por nossos erros, aprendendo com a experiência
- ✅ **Focar no que é melhor** não apenas para nós como indivíduos, mas para a comunidade geral
- ✅ **Colaboração** e espírito de equipe
- ✅ **Inclusão ativa** de novas vozes e perspectivas
- ✅ **Respeito à privacidade** e dados dos usuários
- ✅ **Transparência** em decisões técnicas e de governança
...
- ❌ **Comentários trolladores**, insultuosos ou depreciativos e ataques pessoais ou políticos
...
- ❌ **Violação de privacidade** dos usuários do projeto
- ❌ **Má-fé** em reportes de bugs ou vulnerabilidades
...
Os líderes da comunidade têm o direito e a responsabilidade de remover, editar ou rejeitar comentários, commits, códigos, edições na wiki, issues e outras contribuições que não estejam alinhadas com este Código de Conduta, e comunicarão as razões das decisões de moderação quando apropriado.

---

## Escopo

Este Código de Conduta se aplica dentro de todos os espaços da comunidade e também se aplica quando um indivíduo representa oficialmente a comunidade em espaços públicos.

Exemplos de representação de nossa comunidade incluem:
...
Os líderes da comunidade seguirão estas Diretrizes de Impacto na Comunidade ao determinar as consequências para qualquer ação que julguem violar este Código de Conduta:

#### 1. Correção

**Impacto na Comunidade:** Uso de linguagem imprópria ou outro comportamento considerado anti-profissional.

**Consequência:** Aviso particular por escrito dos líderes da comunidade, esclarecendo a natureza da violação e explicando por que o comportamento foi inadequado. Um pedido público de desculpas pode ser solicitado.
...
**Impacto na Comunidade:** Demonstrar um padrão claro de violação dos padrões da comunidade, incluindo comportamento inadequado sustentado, assédio de um indivíduo ou agressão ou menosprezo a grupos de indivíduos.
...
## Princípios Específicos do Deck

Além do Código de Conduta geral, seguimos princípios específicos relacionados à natureza do projeto:

### Privacidade dos Usuários

- **Nunca** compartilhe dados de usuários sem consentimento explícito
- Respeite a LGPD e regulamentações de privacidade aplicáveis
- Dados sensíveis devem ser tratados com máximo cuidado

### Transparência Técnica

- Decisões arquiteturais importantes devem ser discutidas abertamente
- Mudanças que afetam a privacidade ou segurança requerem revisão da comunidade
- Documentação deve ser mantida atualizada e acessível

### Inclusão de Novos Contribuidores

- Seja paciente e prestativo com novos contribuidores
- Explique convenções e padrões de forma clara
- Ofereça mentoria quando possível

### Respeito à Filosofia do Projeto

Deck é uma rede social **lenta**, **efêmera** e **intencional**. Contribuições devem respeitar esta filosofia:

- Evite features que incentivem vício ou uso compulsivo
- Priorize qualidade sobre quantidade
- Mantenha o foco em privacidade e minimalismo de dados
